      ...
      <div className="space-y-4">
          ...
          <div className="space-y-2 p-3 bg-slate-800/50 rounded-lg border border-slate-700">
            <SampSettingsSection 
                ...
                onSampSettingsChange={onSampSettingsChange}
                ...
                onSaveSampSettings={onSaveSampSettings}
                onUpdateSavedSampSettings={onUpdateSavedSampSettings}
                onDeleteSampSettings={onDeleteSampSettings}
            />
